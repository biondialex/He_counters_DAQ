...
#define ERR_SYNCPROTOCOL     0x000E      //  14 Synchronization protocol of synchronized cards does not match -> either update needed or card types are not synchronizable
...
#define ERR_GOLDENIMAGE      0x0049      //  73 golden image has been booted
...
#define ERR_TOOSMALL         0x0112      // 274 resulting value is too small
